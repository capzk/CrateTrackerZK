...
localeData["SettingsMapList"] = "지도 목록";
localeData["SettingsExpansionVersion"] = "지도 버전";
localeData["SettingsMapSelection"] = "지도 선택";
localeData["SettingsSelectAll"] = "전체 선택";
localeData["SettingsInvertSelection"] = "반전 선택";
...
2. 메시지 설정 페이지 옵션 설명:
   ...
   그룹 알림: 활성화하면 메시지가 파티, 공격대 또는 인스턴스 채팅으로 전송됩니다
