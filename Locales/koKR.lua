...
localeData["SettingsTrajectoryPredictionTestTooltip"] = "활성화하면 로컬 궤적 예측 알림과 지도 낙하지점 표식이 표시됩니다.";
localeData["SettingsTrajectoryTeamAlert"] = "예측 성공 시 팀 메시지 전송";
localeData["SettingsTrajectoryTeamAlertTooltip"] = "활성화하면 예측 성공 시 파티 또는 공격대 채팅으로 전송합니다.";
