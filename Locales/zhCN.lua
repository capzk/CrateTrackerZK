...
localeData["TrajectoryPredictionMatchedUnified"] = "[%s]空投位置已确定：%s";
localeData["TrajectoryPredictionCandidatesAmbiguous"] = "[%s]当前存在多个可能落点:";
...
localeData["SettingsTrajectoryPredictionTestTooltip"] = "开启后，显示本地轨迹预测提示和地图落点标记。";
localeData["SettingsTrajectoryTeamAlert"] = "预测成功发送团队消息";
localeData["SettingsTrajectoryTeamAlertTooltip"] = "开启后，预测成功时发送团队频道消息。";
...
localeData["SettingsMinimapButtonVisible"] = "显示小地图按钮";
localeData["SettingsMinimapButtonVisibleTooltip"] = "开启后显示小地图旁边的插件按钮，关闭后隐藏该按钮。";
