...
localeData["TrajectoryPredictionMatchedUnified"] = "[%s]空投位置已確定：%s";
localeData["TrajectoryPredictionCandidatesAmbiguous"] = "[%s]當前存在多個可能落點:";
...
localeData["SettingsTrajectoryPredictionTestTooltip"] = "開啟後，顯示本地軌跡預測提示和地圖落點標記。";
localeData["SettingsTrajectoryTeamAlert"] = "預測成功發送團隊訊息";
localeData["SettingsTrajectoryTeamAlertTooltip"] = "開啟後，預測成功時發送團隊頻道訊息。";
