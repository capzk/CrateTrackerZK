...
localeData["SettingsLeaderModeTooltip"] = "При включении ручные уведомления о сбросе будут по возможности отправляться в предупреждение рейда; без прав они автоматически вернутся в обычный рейдовый чат.";
