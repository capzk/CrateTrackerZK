...
localeData["TrajectoryPredictionMatchedUnified"] = "[%s] Ubicacion del lanzamiento confirmada: %s";
localeData["TrajectoryPredictionCandidatesAmbiguous"] = "[%s] Existen varios puntos de caida posibles:";
