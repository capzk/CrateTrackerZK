...
localeData["TrajectoryPredictionMatched"] = "[%s] Se ha reconocido la trayectoria del lanzamiento. Coordenadas previstas del punto de caida: %s, %s";
localeData["TrajectoryPredictionWaypointSet"] = "[%s] Se ha marcado en tu mapa el punto previsto de caida: %s, %s";
...
localeData["SettingsTrajectoryPredictionTestTooltip"] = "Cuando esta activado, muestra avisos locales de prediccion y la marca del punto previsto en el mapa.";
localeData["SettingsTrajectoryTeamAlert"] = "Enviar mensaje al equipo al predecir";
localeData["SettingsTrajectoryTeamAlertTooltip"] = "Cuando esta activado, envia el punto previsto de caida al chat del grupo o banda.";
