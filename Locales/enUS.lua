...
localeData["AirdropDetected"] = "[%s]Detected War Supplies airdrop!!!";  -- Unified airdrop message
...
localeData["SettingsMapSelection"] = "Map Selection";
...
localeData["SettingsTrajectoryPredictionTestTooltip"] = "When enabled, shows local trajectory prediction messages and map markers.";
localeData["SettingsTrajectoryTeamAlert"] = "Send Team Prediction Message";
localeData["SettingsTrajectoryTeamAlertTooltip"] = "When enabled, sends successful trajectory predictions to party or raid chat.";
