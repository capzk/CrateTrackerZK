...
localeData["TrajectoryPredictionMatched"] = "[%s] Matched airdrop trajectory, predicted drop coordinates: %d, %d";
localeData["TrajectoryPredictionWaypointSet"] = "[%s] Marked the predicted drop point on your map: %d, %d";
