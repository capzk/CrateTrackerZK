...
UIConfig.mainFrame = {
    background = {0, 0, 0, 0.05},               -- 主框架背景 / Background
}
...
UIConfig.table = {
    ...
    rows = {
        [1] = {255, 255, 255, 0.08},  -- 第1行 / Row 1
        [2] = {255, 255, 255, 0.12},  -- 第2行 / Row 2
        [3] = {255, 255, 255, 0.08},  -- 第3行 / Row 3
        [4] = {255, 255, 255, 0.12},  -- 第4行 / Row 4
        [5] = {255, 255, 255, 0.08},  -- 第5行 / Row 5
        [6] = {255, 255, 255, 0.12},  -- 第6行 / Row 6
        [7] = {255, 255, 255, 0.08},  -- 第7行 / Row 7
        [8] = {255, 255, 255, 0.12},  -- 第8行 / Row 8
        [9] = {255, 255, 255, 0.08},  -- 第9行 / Row 9
        [10] = {255, 255, 255, 0.12}, -- 第10行 / Row 10
    }
}
